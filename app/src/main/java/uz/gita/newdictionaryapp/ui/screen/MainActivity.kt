...
import uz.gita.newdictionaryapp.ui.dialog.AboutDialog
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener {
            ...
            popupMenu.setOnMenuItemClickListener(PopupMenu.OnMenuItemClickListener { item ->
                when (item.itemId) {
                    R.id.favourites -> {
                        startActivity(Intent(this, FavouriteMain::class.java))
                    }
                    R.id.share -> {
                        val intentInvite = Intent(Intent.ACTION_SEND)
                        intentInvite.type = "text/plain"
                        val body = "https://play.google.com/store/apps/details?id=uz.gita.newdictionaryapp"
        ...
        buttonSpeak = findViewById(R.id.btnvoise)
